@echo off
REM Script untuk Upload Gambar ke Server (Windows)
REM Usage: deploy-images-to-server.bat

set SERVER=u689664472@145.79.14.54
set PORT=65002
set REMOTE_PATH=/home/u689664472/domains/portal-rpjmd-kabpasuruan.artdevata.net/public_html/laravel/public
...
echo.
echo 📦 Step 6: Set permission file gambar...
ssh -p %PORT% %SERVER% "chmod 644 %REMOTE_PATH%/uploads/news/*"
