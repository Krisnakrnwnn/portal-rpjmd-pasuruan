...
<body class="font-sans text-gray-800 bg-gray-50 min-h-screen">
  ...
  <aside id="sidebarMenu" class="print:hidden fixed top-0 left-0 z-40 w-64 h-screen transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0 bg-[#03112E] text-white shadow-2xl flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-2" id="nav-container">
      ...
      <button data-target="section-dokumen" class="nav-btn flex items-center px-4 py-3 text-gray-300 hover:bg-white/10 hover:text-white rounded-lg transition-all w-full text-left mt-2">
        ...
        <span class="font-medium text-sm">Bank Data / Dokumen</span>
      </button>

      <button data-target="section-galeri" class="nav-btn flex items-center px-4 py-3 text-gray-300 hover:bg-white/10 hover:text-white rounded-lg transition-all w-full text-left mt-2">
      ...
      <button data-target="section-aspirasi" class="nav-btn flex items-center px-4 py-3 text-gray-300 hover:bg-white/10 hover:text-white rounded-lg transition-all w-full text-left mt-2">
        ...
        <span class="font-medium text-sm">Aspirasi & Pesan</span>
      </button>

      <button data-target="section-ingest" class="nav-btn flex items-center px-4 py-3 text-gray-300 hover:bg-white/10 hover:text-white rounded-lg transition-all w-full text-left mt-2">
        ...
        <span class="font-medium text-sm">Ingest Data Chatbot</span>
      </button>
